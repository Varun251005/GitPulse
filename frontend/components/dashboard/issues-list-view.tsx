    ...
    <div className="space-y-4 sm:space-y-5 font-mono">
        ...
        <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 items-stretch sm:items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 sm:pb-0 scrollbar-none -mx-1 px-1">
            ...
            <Button
              ...
              className="rounded-lg text-xs h-7 sm:h-8 px-2.5 sm:px-3 gap-1 font-mono text-neutral-400 border-neutral-700 shrink-0"
            >
      ...
      {filteredIssues.length > 0 ? (
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2.5 sm:gap-3">
                  ...
                  <div className="flex items-start gap-2.5 sm:gap-3.5 flex-1 min-w-0">
                    <div className="p-1.5 sm:p-2 rounded-lg bg-neutral-900 border border-neutral-800 text-neutral-300 shrink-0 mt-0.5">
                      <CircleDot className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${isOpen ? "text-emerald-400" : "text-neutral-500"}`} />
                    </div>
                    ...
                    <div className="space-y-1.5 sm:space-y-2 flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                        {isOpen ? (
                          <Badge className="bg-emerald-600/15 text-emerald-400 border border-emerald-500/30 gap-1 py-0.5 px-2 font-mono text-[10px] sm:text-xs shrink-0">
                            <CircleDot className="h-2.5 w-2.5 sm:h-3 sm:w-3" />
                            Open
                          </Badge>
                        ) : (
                          <Badge variant="outline" className="bg-neutral-800 text-neutral-400 border-neutral-700 gap-1 py-0.5 px-2 font-mono text-[10px] sm:text-xs shrink-0">
                            <CheckCircle2 className="h-2.5 w-2.5 sm:h-3 sm:w-3" />
                            Closed
                          </Badge>
                        )}
                        <span className="text-[11px] sm:text-xs text-neutral-400 font-bold font-mono">#{issue.number}</span>
        ...
        <div className="flex flex-col items-center justify-center p-8 sm:p-12 rounded-xl sm:rounded-2xl border border-dashed border-neutral-800 bg-neutral-950/40 text-center space-y-2.5">
          ...
          <h3 className="font-semibold text-sm sm:text-base text-white">No issues found</h3>
